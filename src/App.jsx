...
function App() {
  ...
  const { auth, admin, gameManage, dashboard, order, createOrder, addGame, gameDetail, customerManage, profile, discount } = config.adminRoutePath
          ...
          <Routes>
              {token ? (
                <Fragment>
                  ...
                  <Route path={discount} element={<HeaderLayout><Discount/></HeaderLayout>} />
                </Fragment>
              ) : (
